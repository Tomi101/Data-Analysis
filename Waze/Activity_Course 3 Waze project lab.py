...
# 1. Since we are interested in user churn, the 'label' column is needed. Besides 'label', variables that tie to user behaviors will be the most applicable. All variables tie to user behavior except 'ID'.
# 
...
# 
# 4. * Use numpy to investigate the 'mean()' and 'median()' of the data and understand range of data values.
