...
# 1) Videos from verified accounts and videos unverified accounts have different average view counts?
# 
...
# Descriptive statistics are useful because they let you quickly explore and understand large amounts of data. In this case, computing descriptive statistics helps you quickly compute the mean values of video_view_count for each group of verified_status in the sample data.
...
# *   **Null hypothesis**: There is no difference in the number of views between TikTok videos posted by verified accounts and those posted by unverified accounts. Any observed difference in the sample data is attributed to chance or sampling variability.
# 
...
# 
# **$H_1$**: There is a difference in number of views between TikTok videos posted by verified accounts and TikTok videos posted by unverified accounts (any observed difference in the sample data is due to an actual difference in the corresponding population means).
